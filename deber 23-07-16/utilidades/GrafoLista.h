...
#ifndef _GRAFOLISTA2_H
#define _GRAFOLISTA2_H
...
void GrafoLista::setNumVerts(int n)
{ // actualiza numero de vertices
	numVerts = n;
}

void GrafoLista::setVertice(int va, Vertice v)
...
void GrafoLista::setVertice(TipoG a, Vertice v)
{						   // modifica los atributos de un vertice, conociendo su numero
...
void GrafoLista::setArco(TipoG a, TipoG b)
...
void GrafoLista::setArco(TipoG a, TipoG b, int v)
...
int GrafoLista::getNumVerts()
{ // devuelve cantidad de vertices
	return numVerts;
}

Vertice GrafoLista::getVertice(int va)
...
Vertice GrafoLista::getVertice(TipoG a)
...
bool GrafoLista::getArco(int va, int vb)
...
bool GrafoLista::getArco(TipoG a, TipoG b)
...
int GrafoLista::getNumVertice(TipoG v)
...
void GrafoLista::nuevoVertice(TipoG v)
{										   // crea un nuevo vertice recibiendo su valor
...
bool GrafoLista::adyacente(TipoG a, TipoG b)
