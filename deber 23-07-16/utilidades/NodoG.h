...
class NodoG
{				 // definicion de la clase a la que pertenecen los nodos de la lista
...
NodoG::NodoG(TipoG v, int q)
{ // constructor con parametro dato y el peso
	setDato(v);
	setPeso(q);
	setPunt(NULL);
}

NodoG::NodoG(TipoG v, NodoG *p)
{ // constructor con parametro dato y direccion a la cual apuntar
	setDato(v);
	setPunt(p);
}

NodoG::NodoG(TipoG v, int q, NodoG *p)
{ // constructor con parametro dato, peso y direccion a la cual apuntar
	setDato(v);
	setPeso(q);
	setPunt(p);
}

void NodoG::setDato(TipoG v)
{ // metodo que actualiza el estado del atributo
	dato = v;
}
...
TipoG NodoG::getDato()
{ // metodo que devuelve el estado del atributo
	return dato;
}
