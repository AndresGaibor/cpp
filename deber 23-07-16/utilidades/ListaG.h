...
void ListaG::setPrimero(NodoG *p)
{ // metodo que actualiza el apuntador al primer nodo de la lista
	primero = p;
}

NodoG *ListaG::getPrimero()
{ // metodo que devuelve la direccion del primer nodo de la lista
	return primero;
}

bool ListaG::esVacia()
{							// metodo devuelve true si la lista esta vacia
	return primero == NULL; // devuelve true si primero apunta a null
}

void ListaG::anula()
{					  // metodo que anula todos los elementos de la lista
	setPrimero(NULL); // inicializar el apuntador de inicio de la lista
}

void ListaG::insertarAlInicio(TipoG v)
{				  // metodo que inserta un elemento dentro de la lista
...
void ListaG::insertarAlInicio(TipoG v, int q)
{				  // metodo que inserta un elemento dentro de la lista
	NodoG *nuevo; // declaracion de un nuevo nodo
...
void ListaG::insertarAlFinal(TipoG v)
{								  // metodo que inserta un elemento al final de la lista
	...
	{								   // existen otros nodos ya en la lista
...
void ListaG::insertarAlFinal(TipoG v, int q)
{								  // metodo que inserta un elemento al final de la lista
	NodoG *nuevo;				  // declaracion de un nuevo nodo
	NodoG *ultimo = getPrimero(); // apuntador al ultimo nodo de la lista
...
NodoG *ListaG::ultimoValorDeLista()
{				   // metodo que devuelve la direccion del ultimo nodo de la lista
	...
	while (actual->getPunt() != NULL)
	{								// repetir el ciclo mientras el nodo apuntado por actual no apunta a NULL
...
NodoG *ListaG::buscarValorEnLista(TipoG v)
{				   // metodo que devuelve la direccion del nodo que contiene el valor v
	NodoG *actual; // apunta al nodo actual de la lista
	...
	{ // repetir el ciclo mientras el nodo apuntado por actual no apunta a NULL
		if (actual->getDato() == v)
		{				   // el valor almacenado en el nodo referido desde actual es igual al valor buscado
...
void ListaG::insertarUnNodo(TipoG v, NodoG *ant)
{				  // metodo que inserta un elemento nuevo en la lista luego del nodo ant
	NodoG *nuevo; // declaracion de un nuevo nodo
...
void ListaG::insertarUnNodo(TipoG v, int q, NodoG *ant)
{				  // metodo que inserta un elemento nuevo en la lista luego del nodo ant
	NodoG *nuevo; // declaracion de un nuevo nodo
...
void ListaG::eliminarNodoDeLista(TipoG v)
{				   // metodo que elimina el nodo que contiene el valor v de lista
	NodoG *actual; // apunta al nodo actual de la lista
	...
	{									// repetir el ciclo mientras el nodo apuntado por actual no apunta a NULL y no lo encuentre aun
		enc = (actual->getDato() == v); // actualiza el valor de la var bandera: encontrado true, no encontrado false

		if (!enc)
		{								// valor aun no esta en el nodo actual
	...
	if (actual != NULL)
	{ // si el nodo actual no esta al final de la lista
		if (actual == getPrimero())
		{								   // estamos en inicio de la lista
...
void ListaG::insertarEnOrden(TipoG v)
{							   // metodo que inserta ordenadamente un valor dentro de una lista
	NodoG *nuevo;			   // declaracion de un nuevo nodo
...
void ListaG::insertarEnOrden(TipoG v, int q)
{							   // metodo que inserta ordenadamente un valor dentro de una lista
	NodoG *nuevo;			   // declaracion de un nuevo nodo
	NodoG *ant;				   // apuntador al nodo anterior al nodo que se va a insertar
	NodoG *ult = getPrimero(); // apuntador al ultimo nodo de la lista
